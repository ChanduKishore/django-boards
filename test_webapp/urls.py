...
urlpatterns = [
    ...
    path('seetings/password/change/done',auth_views.PasswordChangeDoneView.as_view(
    ...
    path('boards/<int:board_id>/topics/<int:topic_id>/edit/<int:post_id>/',
            views.PostUpdateView.as_view(), name='edit_post'),

    path('setting/accounts/', account_views.UserUpdateView.as_view(), name='my_accounts')
